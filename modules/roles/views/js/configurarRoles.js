var configurarRoles_ = function(){
    ...
    this.public.getGridRoles = function (){
        var oTable = $('#gridRoles').dataTable({
            ...
            $('#'+diccionario.tabs.T1+'refresh').click(function(){
                   oTable.fnReloadAjax(oTable.fnSettings());
                }); 
            },
            fnInfoCallback: function( oSettings, iStart, iEnd, iMax, iTotal, sPre ) {
               return '<button id="'+diccionario.tabs.T1+'refresh" class="btn btn-primary" title="Actualizar"><i class="fa fa-refresh"></i></button> '+iStart +" al "+ iEnd+' de '+iTotal;
           }
        });
