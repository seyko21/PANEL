var registrarVendedor_ = function(){
    ...
    _private.config = {
        modulo: 'configuracion/registrarVendedor/'
    };
...
this.publico.getGridVendedor = function (){
        $('#'+diccionario.tabs.T7+'gridVendedor').dataTable({
            bProcessing: true,
            bServerSide: true,
            bDestroy: true,
            ...
            iDisplayLength: 10,            
            aoColumns: [
                {sTitle: "<input type='checkbox' id='"+diccionario.tabs.T7+"chk_all' onclick='simpleScript.checkAll(this,\"#"+diccionario.tabs.T7+"gridVendedor\");'>", sWidth: "1%", sClass: "center", bSortable: false},
            ...
            fnDrawCallback: function() {
                $('#'+diccionario.tabs.T7+'gridVendedor_filter').find('input').attr('placeholder','Buscar');
