...
class generarCotizacionModel extends Model{
    ...
    public function getGridGenerarCotizacion(){
        $aColumns       =   array( 'chk','codigo','nombre_descripcion','fecha','moneda','monto_total', 'estado'); //para la ordenacion y pintado en html
        /*
    ...
    private function anularUnaCotizacion(){
        $query = "call sp_ventaAnulacion(:flag,:idCotizacion);";
        $parms = array(
            ':flag' =>'2',
            ':idCotizacion' => $this->_idCotizacion           
        );
