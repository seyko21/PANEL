...
class alquilerCulminarModel extends Model{
    ...
    public function getAlquilerCulminar(){
        $aColumns       =   array("codigo","orden_numero","ordenin_numero","cliente" ,"fecha_inicio","fecha_termino","meses_contrato","dias_oferta","importe_incigv"); //para la ordenacion y pintado en html
        /*
