...
(function ($, window, document, undefined) {
            ...
            if (storage && self.o.localStorage && getKeySettings) {
                ...
                for (var key in jsonSettings.widget) {
                    ...
                    if (jsonSettings.widget[key].hidden == 1) {
                        //widgetId.hide(1) cuando se creaba dos widgets, solo de visualizaba uno.
                    } else {
    ...
    $.fn[pluginName] = function (option) {
        return this.each(function () {
            var $this = $(this);
            $this.data(pluginName, null); //RDCC
